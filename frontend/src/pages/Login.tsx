...
import { BarChart3, Eye, EyeOff, TrendingUp, Package, Zap } from "lucide-react";
...
export default function Login() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    login(
      { id: 1, name: "Cristóbal Flores", email: "cristobal@distribuidora.cl", role: "admin", business_id: 1 },
      "mock-token"
    );
    navigate("/dashboard");
  };
      ...
      <div className="flex-1 bg-white flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              className="w-full py-3 px-4 rounded-xl bg-orange-600 font-semibold text-white transition-opacity duration-200 hover:opacity-90 focus:ring-2 focus:ring-offset-2 focus:ring-orange-500"
            >
              Iniciar sesión
            </button>
          </form>
